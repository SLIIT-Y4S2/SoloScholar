...
const LESSON_OUTLINE: LessonOutlineType[] = [
  {
    ...
    learningOutcomes: [
      {
        outcome: "Describe the principles and techniques of query optimization, estimate the cost of query plans and database tuning.",
  ...
  },
  {
    ...
    learningOutcomes: [
      {
        outcome: "Design and develop NoSQL and XML database systems for real world applications.",
  ...
  },
  {
    ...
    learningOutcomes: [
      {
        outcome: "Recommend suitable transaction and concurrency control solutions for data intensive application.",
  ...
  },
  {
    ...
    learningOutcomes: [
      {
        outcome: "Explain the concepts underlying in Distributed and Parallel RDBMS architectures and associate protocols for distributed transaction processing.",
  ...
  },
  {
    ...
    learningOutcomes: [
      {
        outcome: "Utilize Hadoop framework and supporting tools to execute Map Reduce program model for distributed processing",
