    ...
    <Content className="bg-white flex flex-col mx-auto p-8 w-full max-w-[1300px] max-h-[800] h-min rounded-2xl">
      <form className="" onSubmit={handleSubmit}>
        ...
        <div className="my-4">
          ...
          <textarea
            className="overflow-visible bg-sky-950 text-white w-full h-48 p-4 resize-none custom-scrollbar"
            ref={answerRef}
          />
        </div>
        <div className="flex justify-end items-center">
          ...
          {isLoading ? (
            ...
            <button className="bg-blue-600 text-white py-2 px-4 w-max rounded-xl">
              {"Submit"}
            </button>
          )}
        </div>
